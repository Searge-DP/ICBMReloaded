package icbmrl.sentry.turret.items;
...
public class ItemSentryUpgrade extends ItemICBMBase implements IUpgrade
{
    ...
    {
        return "item." + ModInfo.PREFIX + Upgrades.values()[itemStack.getItemDamage()].name;
    }
    ...
    public void registerIcons(IconRegister iconRegister)
    {
        ...
        {
            Upgrades.setIcon(meta, iconRegister.registerIcon(ModInfo.PREFIX + Upgrades.values()[meta].iconName));
        }
    }
