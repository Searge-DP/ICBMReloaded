...
public class ItemAmmo extends ItemICBMBase implements IAmmunition
{
    ...
    {
        return "item." + ModInfo.PREFIX + AmmoType.values()[itemStack.getItemDamage()].iconName;
    }
    ...
    public void registerIcons(IconRegister iconRegister)
    {
        ...
        {
            ICONS[i] = iconRegister.registerIcon(ModInfo.PREFIX + AmmoType.values()[i].iconName);
        }
    }
