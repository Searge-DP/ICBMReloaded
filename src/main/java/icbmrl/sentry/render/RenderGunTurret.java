...
{
    public static final IModelCustom MODEL = AdvancedModelLoader.loadModel(ModInfo.MODEL_DIRECTORY + "turret_gun.tcn");
    ...
    {
        super(new ResourceLocation(ModInfo.DOMAIN, ModInfo.MODEL_TEXTURE_PATH + "gun_turret_neutral.png"));
        textureFriendly = new ResourceLocation(ModInfo.DOMAIN, ModInfo.MODEL_TEXTURE_PATH + "gun_turret_friendly.png");
        textureHostile = new ResourceLocation(ModInfo.DOMAIN, ModInfo.MODEL_TEXTURE_PATH + "gun_turret_hostile.png");
    }
