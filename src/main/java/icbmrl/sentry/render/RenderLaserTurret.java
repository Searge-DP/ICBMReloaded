...
{
    public static final IModelCustom MODEL = AdvancedModelLoader.loadModel(ModInfo.MODEL_DIRECTORY + "turret_laser.tcn");
    ...
    {
        super(new ResourceLocation(ModInfo.DOMAIN, ModInfo.MODEL_TEXTURE_PATH + "laser_turret_neutral.png"));
        textureFriendly = new ResourceLocation(ModInfo.DOMAIN, ModInfo.MODEL_TEXTURE_PATH + "laser_turret_friendly.png");
        textureHostile = new ResourceLocation(ModInfo.DOMAIN, ModInfo.MODEL_TEXTURE_PATH + "laser_turret_hostile.png");
    }
