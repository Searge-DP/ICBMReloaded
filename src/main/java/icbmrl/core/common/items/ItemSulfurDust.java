...
public class ItemSulfurDust extends ItemICBMBase
{
    ...
    public void registerIcons(IconRegister iconRegister)
    {
        ...
        this.itemIcon = iconRegister.registerIcon(ModInfo.PREFIX + "sulfur");
        
        // First damage value contains icon for saltpeter.
        this.salt_icon = iconRegister.registerIcon(ModInfo.PREFIX + "saltpeter");
    }
    ...
    public String getUnlocalizedName(ItemStack par1ItemStack)
    {
        ...
        {
            return "item." + ModInfo.PREFIX + "saltpeter";
        }
