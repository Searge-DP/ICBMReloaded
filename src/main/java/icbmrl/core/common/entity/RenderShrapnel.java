...
public class RenderShrapnel extends Render
{
	...
	public static final ResourceLocation TEXTURE_FILE = new ResourceLocation(ModInfo.DOMAIN, ModInfo.MODEL_TEXTURE_PATH + "fragment.png");
	...
	public void renderArrow(EntityFragments suiPian, double par2, double par4, double par6, float par8, float par9)
	{
		if (suiPian.isAnvil)
		{
			...
			var12.setTranslation((-MathHelper.floor_double(suiPian.posX)) - 0.5F, (-MathHelper.floor_double(suiPian.posY)) - 0.5F,
					(-MathHelper.floor_double(suiPian.posZ)) - 0.5F);
			this.blockRenderer.renderBlockByRenderType(block, MathHelper.floor_double(suiPian.posX), MathHelper.floor_double(suiPian.posY),
