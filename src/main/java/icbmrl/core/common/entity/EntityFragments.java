...
public class EntityFragments extends Entity implements IEntityAdditionalSpawnData
{
	...
	public void onUpdate()
	{
		...
		else
		{
					...
					if (movingObjPos.entityHit.attackEntityFrom(damageSource, damage))
					{
						if (movingObjPos.entityHit instanceof EntityLiving)
						{
							...
							if (this.knowBackStrength > 0)
							{
								...
								if (var21 > 0.0F)
								{
									movingObjPos.entityHit.addVelocity(this.motionX * this.knowBackStrength * 0.6000000238418579D / var21, 0.1D,
											this.motionZ * this.knowBackStrength * 0.6000000238418579D / var21);
								}
							}
						}
			...
			if (this.arrowCritical)
			{
				...
				{
					this.worldObj.spawnParticle("crit", this.posX + this.motionX * var8 / 4.0D, this.posY + this.motionY * var8 / 4.0D,
							this.posZ + this.motionZ * var8 / 4.0D, -this.motionX, -this.motionY + 0.2D, -this.motionZ);
				}
			}
			...
			for (this.rotationPitch = (float) (Math.atan2(this.motionY, speed) * 180.0D / Math.PI); this.rotationPitch
			...
			if (this.isInWater())
			{
				...
				{
					float var24 = 0.25F;
					this.worldObj.spawnParticle("bubble", this.posX - this.motionX * var24, this.posY - this.motionY * var24,
							this.posZ - this.motionZ * var24, this.motionX, this.motionY, this.motionZ);
				}
	...
	public void readEntityFromNBT(NBTTagCompound par1NBTTagCompound)
	{
		...
		this.inData = par1NBTTagCompound.getByte("inData");
		this.arrowShake = par1NBTTagCompound.getByte("shake");
