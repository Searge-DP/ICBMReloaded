...
public class BlockConcrete extends BaseBlock // implements IAntiPoisonBlock
{
	...
	/*
	 * @Override public boolean isPoisonPrevention(World par1World, int x, int
	 * y, int z, String type) { return type.equalsIgnoreCase("radiation"); }
	 */
