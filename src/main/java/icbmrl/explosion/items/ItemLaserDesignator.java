package icbmrl.explosion.items;
...
import icbmrl.core.common.prefab.item.ItemICBMElectrical;
import icbmrl.explosion.ICBMExplosion;
import icbmrl.explosion.entities.EntityLightBeam;
import icbmrl.explosion.machines.launcher.TileLauncherPrefab;
...
{
    public static final int BAN_JING = InitModMetadata.DAO_DAN_ZUI_YUAN;
    ...
    public void onReceivePacket(ByteArrayDataInput data, EntityPlayer player, Object... extra)
    {
        ...
        player.worldObj.playSoundEffect(position.intX(), player.worldObj.getHeightValue(position.intX(), position.intZ()), position.intZ(), ModInfo.PREFIX + "airstrike", 5.0F, (1.0F + (player.worldObj.rand.nextFloat() - player.worldObj.rand.nextFloat()) * 0.2F) * 0.7F);
