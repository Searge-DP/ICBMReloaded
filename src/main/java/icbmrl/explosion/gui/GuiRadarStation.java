...
import icbmrl.core.common.gui.GuiICBM;
...
{
    public static final ResourceLocation TEXTURE = new ResourceLocation(ModInfo.DOMAIN, ModInfo.GUI_PATH + "gui_radar.png");
    public static final ResourceLocation TEXTURE_RED_DOT = new ResourceLocation(ModInfo.DOMAIN, ModInfo.GUI_PATH + "reddot.png");
    public static final ResourceLocation TEXTURE_YELLOW_DOT = new ResourceLocation(ModInfo.DOMAIN, ModInfo.GUI_PATH + "yellowdot.png");
    public static final ResourceLocation TEXTURE_WHITE_DOT = new ResourceLocation(ModInfo.DOMAIN, ModInfo.GUI_PATH + "whitedot.png");
