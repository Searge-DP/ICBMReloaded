package icbmrl.explosion.machines;
...
import icbmrl.core.common.prefab.TileICBM;
...
public class TileEMPTower extends TileICBM implements IMultiBlock, IRedstoneReceptor, IBlockActivate, SimpleComponent
{
    ...
    public void updateEntity()
    {
        ...
        if (ticks % 20 == 0 && getEnergyHandler().getEnergy() > 0)
            worldObj.playSoundEffect(xCoord, yCoord, zCoord, ModInfo.PREFIX + "machinehum", 0.5F, 0.85F * getEnergyHandler().getEnergy() / getEnergyHandler().getEnergyCapacity());
