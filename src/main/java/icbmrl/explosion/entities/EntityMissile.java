package icbmrl.explosion.entities;
...
import icbmrl.core.common.lib.DamageUtility;
...
public class EntityMissile extends Entity implements IChunkLoadHandler, IExplosiveContainer, IEntityAdditionalSpawnData, IMissile, ITarget
{
    ...
    public void launch(Vector3 target)
    {
        ...
        this.worldObj.playSoundAtEntity(this, ModInfo.PREFIX + "missilelaunch", 4F, (1.0F + (this.worldObj.rand.nextFloat() - this.worldObj.rand.nextFloat()) * 0.2F) * 0.7F);
    ...
    {
        if (!this.worldObj.isRemote && InitModMetadata.LOAD_CHUNKS && this.chunkTicket != null)
        {
