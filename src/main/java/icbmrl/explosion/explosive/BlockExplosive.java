...
import icbmrl.core.common.prefab.BlockICBM;
...
public class BlockExplosive extends BlockICBM implements ICamouflageMaterial
{
    ...
    public Icon getIcon(IconRegister iconRegister, Explosive zhaPin, String suffix)
    {
        ...
        try
        {
            ResourceLocation resourcelocation = new ResourceLocation(ModInfo.DOMAIN, ModInfo.BLOCK_PATH + iconName + ".png");
            ...
            {
                return iconRegister.registerIcon(ModInfo.PREFIX + iconName);
            }
        }
        catch (Exception e)
        {
        ...
        {
            return iconRegister.registerIcon(ModInfo.PREFIX + "explosive_bottom_" + zhaPin.getTier());
        }

        return iconRegister.registerIcon(ModInfo.PREFIX + "explosive_base_" + zhaPin.getTier());
    }
