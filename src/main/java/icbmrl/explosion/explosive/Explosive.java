package icbmrl.explosion.explosive;
...
import icbmrl.explosion.ex.ExAntiGravitational;
import icbmrl.explosion.ex.ExAntimatter;
import icbmrl.explosion.ex.ExBreaching;
import icbmrl.explosion.ex.ExChemical;
import icbmrl.explosion.ex.ExCondensed;
import icbmrl.explosion.ex.ExDebilitation;
import icbmrl.explosion.ex.ExEMP;
import icbmrl.explosion.ex.ExEnder;
import icbmrl.explosion.ex.ExEndothermic;
import icbmrl.explosion.ex.ExExothermic;
import icbmrl.explosion.ex.ExIncendiary;
import icbmrl.explosion.ex.ExNuclear;
import icbmrl.explosion.ex.ExRedMatter;
import icbmrl.explosion.ex.ExRejuvenation;
import icbmrl.explosion.ex.ExRepulsive;
import icbmrl.explosion.ex.ExSMine;
import icbmrl.explosion.ex.ExShrapnel;
import icbmrl.explosion.ex.ExSonic;
import icbmrl.explosion.ex.Explosion;
import icbmrl.explosion.ex.missiles.MissileAnti;
import icbmrl.explosion.ex.missiles.MissileCluster;
import icbmrl.explosion.ex.missiles.MissileHoming;
import icbmrl.explosion.ex.missiles.MissileModule;
import icbmrl.explosion.ex.missiles.MissileNuclearCluster;
...
public abstract class Explosive implements IExplosive
{
    ...
    static
    {
        InitModMetadata.CONFIGURATION.load();
        ...
        InitModMetadata.CONFIGURATION.save();
        registered = true;
    }
    ...
    protected Explosive(String name, int tier)
    {
        ...
        this.isDisabled = InitModMetadata.CONFIGURATION.get("Disable_Explosives", "Disable " + this.nameID, false).getBoolean(false);
