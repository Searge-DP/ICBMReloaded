...
public class BlastFire extends Blast
{
    ...
    public void doExplode()
    {
        ...
        world().playSoundEffect(position.x + 0.5D, position.y + 0.5D, position.z + 0.5D, ModInfo.PREFIX + "explosionfire", 4.0F, (1.0F + (world().rand.nextFloat() - world().rand.nextFloat()) * 0.2F) * 1F);
    }
