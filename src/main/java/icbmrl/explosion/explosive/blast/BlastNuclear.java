package icbmrl.explosion.explosive.blast;
...
import icbmrl.explosion.explosive.thread.ThreadLargeExplosion;
...
public class BlastNuclear extends Blast
{
    ...
    static
    {
        ...
        POLLUTIVE_NUCLEAR = InitModMetadata.CONFIGURATION.get(Configuration.CATEGORY_GENERAL, "Pollutive Nuclear", POLLUTIVE_NUCLEAR).getBoolean(POLLUTIVE_NUCLEAR);
    ...
    public void doPreExplode()
    {
        ...
        this.world().playSoundEffect(this.position.x, this.position.y, this.position.z, ModInfo.PREFIX + "explosion", 7.0F, (1.0F + (this.world().rand.nextFloat() - this.world().rand.nextFloat()) * 0.2F) * 0.7F);
    }
    ...
    public void doPostExplode()
    {
        ...
        this.world().playSoundEffect(this.position.x, this.position.y, this.position.z, ModInfo.PREFIX + "explosion", 10.0F, (1.0F + (this.world().rand.nextFloat() - this.world().rand.nextFloat()) * 0.2F) * 0.7F);
    }
