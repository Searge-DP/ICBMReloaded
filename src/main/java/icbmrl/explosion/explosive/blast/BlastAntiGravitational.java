...
import icbmrl.explosion.explosive.thread.ThreadSmallExplosion;
...
public class BlastAntiGravitational extends Blast
{
    ...
    public void doPreExplode()
    {
        ...
        this.world().playSoundEffect(position.x, position.y, position.z, ModInfo.PREFIX + "antigravity", 6.0F, (1.0F + (world().rand.nextFloat() - world().rand.nextFloat()) * 0.2F) * 0.7F);
    }
