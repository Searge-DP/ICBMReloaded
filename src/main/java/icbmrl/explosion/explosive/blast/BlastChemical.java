...
public class BlastChemical extends Blast
{
    ...
    public void doPreExplode()
    {
        ...
        {
            this.world().playSoundEffect(this.position.x, this.position.y, this.position.z, ModInfo.PREFIX + "debilitation", 4.0F, (1.0F + (world().rand.nextFloat() - world().rand.nextFloat()) * 0.2F) * 0.7F);
        }
    }
    ...
    public void doExplode()
    {
        ...
        if (this.playShortSoundFX)
        {
            world().playSoundEffect(position.x + 0.5D, position.y + 0.5D, position.z + 0.5D, ModInfo.PREFIX + "gasleak", 4.0F, (1.0F + (world().rand.nextFloat() - world().rand.nextFloat()) * 0.2F) * 1F);
        }
