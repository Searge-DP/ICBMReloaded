package icbmrl.explosion.render.entity;
...
{
    public static final ResourceLocation TEXTURE_FILE = new ResourceLocation(ModInfo.DOMAIN, ModInfo.TEXTURE_PATH + "blackhole.png");
