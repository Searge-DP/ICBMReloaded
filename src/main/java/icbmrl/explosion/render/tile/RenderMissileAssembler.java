...
import icbmrl.explosion.model.tiles.ModelMissileAssemblerClaw;
import icbmrl.explosion.model.tiles.ModelMissileAssemblerPanel;
...
{
    public static final ResourceLocation TEXTURE_FILE = new ResourceLocation(ModInfo.DOMAIN, ModInfo.MODEL_TEXTURE_PATH + "missileAssembler.png");
