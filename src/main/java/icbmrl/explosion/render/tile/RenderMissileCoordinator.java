...
import icbmrl.explosion.model.tiles.ModelMissileCoordinator;
import org.lwjgl.opengl.GL11;

@SideOnly(Side.CLIENT)
public class RenderMissileCoordinator extends TileEntitySpecialRenderer
{
    public static final ResourceLocation TEXTURE_FILE = new ResourceLocation(ModInfo.DOMAIN, ModInfo.MODEL_TEXTURE_PATH + "missile_coordinator_off.png");
    public static final ResourceLocation TEXTURE_FILE_ON = new ResourceLocation(ModInfo.DOMAIN, ModInfo.MODEL_TEXTURE_PATH + "missile_coordinator_on.png");
