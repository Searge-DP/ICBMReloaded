...
import icbmrl.explosion.model.tiles.MXiaoFaSheQi;
import icbmrl.explosion.model.tiles.MXiaoFaSheQiJia;
import org.lwjgl.opengl.GL11;

@SideOnly(Side.CLIENT)
public class RenderCruiseLauncher extends TileEntitySpecialRenderer
{
    public static final ResourceLocation TEXTURE_FILE = new ResourceLocation(ModInfo.DOMAIN, ModInfo.MODEL_TEXTURE_PATH + "cruise_launcher.png");
