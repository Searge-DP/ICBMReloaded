...
import icbmrl.explosion.model.tiles.MFaSheDi0;
import icbmrl.explosion.model.tiles.MFaSheDi1;
import icbmrl.explosion.model.tiles.MFaSheDi2;
import icbmrl.explosion.model.tiles.MFaSheDiRail0;
import icbmrl.explosion.model.tiles.MFaSheDiRail1;
import icbmrl.explosion.model.tiles.MFaSheDiRail2;
import org.lwjgl.opengl.GL11;

@SideOnly(Side.CLIENT)
public class RenderLauncherBase extends TileEntitySpecialRenderer
{
    public static final ResourceLocation TEXTURE_FILE_0 = new ResourceLocation(ModInfo.DOMAIN, ModInfo.MODEL_TEXTURE_PATH + "launcher_0.png");
    public static final ResourceLocation TEXTURE_FILE_1 = new ResourceLocation(ModInfo.DOMAIN, ModInfo.MODEL_TEXTURE_PATH + "launcher_1.png");
    public static final ResourceLocation TEXTURE_FILE_2 = new ResourceLocation(ModInfo.DOMAIN, ModInfo.MODEL_TEXTURE_PATH + "launcher_2.png");
